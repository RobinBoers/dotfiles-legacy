...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "dev", "www", "chat", "doc", "music", "games", "term", "edit", "more" }, s, awful.layout.layouts[1])
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "bottom", screen = s, height = "40", ontop = true, type = "panel" })
...
awful.key({ "Mod1", "Shift"   }, "Tab",
    ...
    end,{description = "switch windows (reverse)", group = "client"}),
    ...
    awful.key({ "Control", "Mod1" }, "r", awesome.restart,
              {description = "reload awesome", group = "awesome"}),
    awful.key({ "Control", "Mod1"   }, "q", awesome.quit,
    ...
    awful.key({ "Mod1" },            "F1",     function () awful.spawn("rofi -show drun -theme qmenu") end,
              {description = "bring up rofi", group = "launcher"}),
...
for i = 1, 9 do
    globalkeys = gears.table.join(globalkeys,
        ...
        awful.key({ modkey, "Shift" }, "#" .. i + 9,
                  ...
                  {description = "move client to #"..i, group = "tag"}),
        ...
        awful.key({ modkey, "Control", "Shift" }, "#" .. i + 9,
                  ...
                  {description = "toggle client on #" .. i, group = "tag"})
    )
end
...
awful.mouse.resize.add_leave_callback(function(c, _, args)
   ...
   and coords.y >= sg.y
    then
   --awful.placement.maximize(c, {honor_workarea=false})
   c.maximized = not c.maximized
    end
end, "mouse.move")
