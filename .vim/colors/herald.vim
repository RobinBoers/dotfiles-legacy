...
hi mbenormal guifg=#41ff41 guibg=#3f3d3d guisp=#3f3d3d gui=NONE ctermfg=83 ctermbg=237 cterm=NONE
hi perlspecialstring guifg=#ff0606 guibg=#40400f guisp=#40400f gui=NONE ctermfg=196 ctermbg=58 cterm=NONE
hi doxygenspecial guifg=#0aff0a guibg=NONE guisp=NONE gui=NONE ctermfg=10 ctermbg=NONE cterm=NONE
hi mbechanged guifg=#ffa771 guibg=#3f3d3d guisp=#3f3d3d gui=NONE ctermfg=215 ctermbg=237 cterm=NONE
hi mbevisiblechanged guifg=#ffa771 guibg=#8f384d guisp=#8f384d gui=NONE ctermfg=215 ctermbg=95 cterm=NONE
hi doxygenparam guifg=#0aff0a guibg=NONE guisp=NONE gui=NONE ctermfg=10 ctermbg=NONE cterm=NONE
hi doxygensmallspecial guifg=#0aff0a guibg=NONE guisp=NONE gui=NONE ctermfg=10 ctermbg=NONE cterm=NONE
hi doxygenprev guifg=#0aff0a guibg=NONE guisp=NONE gui=NONE ctermfg=10 ctermbg=NONE cterm=NONE
hi perlspecialmatch guifg=#ff0606 guibg=#40400f guisp=#40400f gui=NONE ctermfg=196 ctermbg=58 cterm=NONE
hi cformat guifg=#ff0606 guibg=#40400f guisp=#40400f gui=NONE ctermfg=196 ctermbg=58 cterm=NONE
hi lcursor guifg=#ff2bff guibg=#f2faff guisp=#f2faff gui=NONE ctermfg=13 ctermbg=195 cterm=NONE
hi doxygenspecialmultilinedesc guifg=#ffa1ff guibg=NONE guisp=NONE gui=NONE ctermfg=219 ctermbg=NONE cterm=NONE
hi taglisttagname guifg=#ff02a6 guibg=NONE guisp=NONE gui=NONE ctermfg=199 ctermbg=NONE cterm=NONE
hi doxygenbrief guifg=#d8ffd8 guibg=NONE guisp=NONE gui=NONE ctermfg=194 ctermbg=NONE cterm=NONE
hi mbevisiblenormal guifg=#6eff6e guibg=#8f384d guisp=#8f384d gui=NONE ctermfg=83 ctermbg=95 cterm=NONE
hi user2 guifg=#ff0d0d guibg=#5e1948 guisp=#5e1948 gui=NONE ctermfg=196 ctermbg=53 cterm=NONE
hi user1 guifg=#6a6aff guibg=#5e1948 guisp=#5e1948 gui=NONE ctermfg=63 ctermbg=53 cterm=NONE
hi doxygenspecialonelinedesc guifg=#ffa1ff guibg=NONE guisp=NONE gui=NONE ctermfg=219 ctermbg=NONE cterm=NONE
hi doxygencomment guifg=#ffc8c8 guibg=NONE guisp=NONE gui=NONE ctermfg=224 ctermbg=NONE cterm=NONE
hi cspecialcharacter guifg=#ff0606 guibg=#40400f guisp=#40400f gui=NONE ctermfg=196 ctermbg=58 cterm=NONE
hi pythonimport guifg=#ff2bff guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi pythonexception guifg=#ff75ff guibg=NONE guisp=NONE gui=NONE ctermfg=213 ctermbg=NONE cterm=NONE
hi pythonbuiltinfunction guifg=#ff2bff guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi pythonoperator guifg=#ff5454 guibg=NONE guisp=NONE gui=NONE ctermfg=203 ctermbg=NONE cterm=NONE
hi pythonexclass guifg=#ff2bff guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi pythonbuiltin guifg=#ff2bff guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi phpstringdouble guifg=#6ec7ff guibg=NONE guisp=NONE gui=NONE ctermfg=75 ctermbg=NONE cterm=NONE
hi htmltagname guifg=#6ec7ff guibg=NONE guisp=NONE gui=NONE ctermfg=75 ctermbg=NONE cterm=NONE
hi javascriptstrings guifg=#6ec7ff guibg=NONE guisp=NONE gui=NONE ctermfg=75 ctermbg=NONE cterm=NONE
hi htmlstring guifg=#6ec7ff guibg=NONE guisp=NONE gui=NONE ctermfg=75 ctermbg=NONE cterm=NONE
hi phpstringsingle guifg=#6ec7ff guibg=NONE guisp=NONE gui=NONE ctermfg=75 ctermbg=NONE cterm=NONE
hi stringdelimiter guifg=#ff2bff guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi rubyregexp guifg=#ff78ff guibg=NONE guisp=NONE gui=NONE ctermfg=213 ctermbg=NONE cterm=NONE
hi string guifg=#36ff83 guibg=NONE guisp=NONE gui=NONE ctermfg=85 ctermbg=NONE cterm=NONE
hi constant guifg=#e8ffc3 guibg=NONE guisp=NONE gui=NONE ctermfg=193 ctermbg=NONE cterm=NONE
hi normal guifg=#65ffcc guibg=#150515 guisp=#150515 gui=NONE ctermfg=86 ctermbg=233 cterm=NONE
hi rubyinstancevariable guifg=#ff3683 guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi rubyclass guifg=#ff2bff guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi identifier guifg=#ff3683 guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi comment guifg=#ff2bff guibg=NONE guisp=NONE gui=italic ctermfg=13 ctermbg=NONE cterm=NONE
hi rubyregexpdelimiter guifg=#ff2bff guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi rubyregexpspecial guifg=#ffffa1 guibg=NONE guisp=NONE gui=NONE ctermfg=229 ctermbg=NONE cterm=NONE
hi rubypredefinedidentifier guifg=#ffffdd guibg=NONE guisp=NONE gui=NONE ctermfg=230 ctermbg=NONE cterm=NONE
hi function guifg=#f2fff2 guibg=NONE guisp=NONE gui=NONE ctermfg=194 ctermbg=NONE cterm=NONE
hi directory guifg=#11ff64 guibg=NONE guisp=NONE gui=NONE ctermfg=47 ctermbg=NONE cterm=NONE
hi rubysymbol guifg=#ff7017 guibg=NONE guisp=NONE gui=NONE ctermfg=202 ctermbg=NONE cterm=NONE
hi rubycontrol guifg=#ff06ff guibg=NONE guisp=NONE gui=NONE ctermfg=201 ctermbg=NONE cterm=NONE
hi rubyidentifier guifg=#ff3683 guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
